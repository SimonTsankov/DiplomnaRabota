...
export const environment = {
  ...
  production: false,
  redTheme: [
    { attribute: "--neon-clr", value: "hsl(0,0%,100%)"},
    { attribute: "--neon-clr2", value: "#e0d5be"},
    { attribute: "--bckg-menu", value: "#c7c5c5"},
    { attribute: "--LogRegColor", value: "#d9d9d9"},
    { attribute: "--LogRegColorTwo", value: "rgb(255,255,255)"},
    { attribute: "--main-color-one", value: "#8e8c86"},
